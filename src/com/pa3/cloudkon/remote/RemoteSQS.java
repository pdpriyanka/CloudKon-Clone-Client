...
public class RemoteSQS {
	...
	public void initSQSURL() {
		...
		try {
	        InputStream credentialsFile = getClass().getClassLoader().getResourceAsStream("awsSecuCredentials.properties");
	...
	public AmazonSQS getAmazonSQS() {
		if (amazonSQS == null) {
			AWSCredentials awsCredentials = null;
			try {
		        //InputStream credentialsFile = getClass().getResourceAsStream("awsSecuCredentials.properties");
	...
	/*public static void main(String[] args) {
		RemoteSQS remoteSQS = new RemoteSQS(args[0]);
		if(remoteSQS.isSQSExists()){
			remoteSQS.initSQSURL();
			remoteSQS.sendMessage("0:sleep 0");
			Message message = remoteSQS.ReceivingMessage();
			System.out.println(message.getBody());
			remoteSQS.deleteMessage(message);
			message = remoteSQS.ReceivingMessage();
			if(message!=null)
			System.out.println(message.getBody());
